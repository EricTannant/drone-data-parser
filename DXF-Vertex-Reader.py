...
class Polyline:
    ...
    def _calculate_variance(self):
        ...
        for dx1 in variations:
            for dy1 in variations:
                for dz1 in variations:
                    for dx2 in variations:
                        for dy2 in variations:
                            for dz2 in variations:
                                for dx3 in variations:
                                    for dy3 in variations:
                                        for dz3 in variations:
                                            ...
                                            dip, dip_direction, _ = self._calculate_properties_for_points(
                                                varied_p1, varied_p2, varied_p3)
    ...
    def _calculate_circular_variance(angles):
        ...
        # For small variations, we can use simple max-min approach
        # but we need to handle the circular nature (e.g., 359° and 1° are close)
...
def write_polylines_to_file(polylines: Dict[str, Polyline], output_path: str, source_file: str) -> bool:
    ...
    try:
        with open(output_path, 'w') as output_file:
            ...
            output_file.write("Polyline,Vertex1_X,Vertex1_Y,Vertex1_Z,Vertex2_X,Vertex2_Y,Vertex2_Z,Vertex3_X,Vertex3_Y,Vertex3_Z\n")
