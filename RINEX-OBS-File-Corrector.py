...
Output:
    - Corrected .obs files with "_corrected.txt" suffix
"""
...
class RinexObsCorrector:
    ...
    def process_obs_file(self, filename: str) -> bool:
        ...
        try:
            ...
            temp_filename = "temp_rinex_processing.txt"
    ...
    def print_summary(self, successful_count: int, total_count: int):
        ...
        if successful_count > 0:
            print(f"\nCorrected files can be found in the same folder with '_corrected.txt' suffix.")
