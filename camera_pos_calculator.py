...
def interpolate_coordinates(hour: float, rinex_data: List[List[float]],
                           offset: List[float]) -> Tuple[float, float, float]:
    """
...
def camera_position_calculator():
    ...
    try:
        ...
        output_file_path = os.path.join(script_directory, 'Camera_coords.csv')
...
if __name__ == "__main__":
    try:
        ...
        if success:
            ...
            print("SUCCESS: Output file created: Camera_coords.csv")
